...
from converter.bvh_converter.bvh import BvhReader
...
class Skeleton:
    ...
    def get_frames_worldpos(self, n=None):
        ...
        frame_data = []
        if n is None:
            print("Key Frames " , len(self.keyframes))
...
def process_bvhkeyframe(keyframe, joint, t, DEBUG=0):
    ...
    # print("In World LEvel sopmeat Pose :", t)
    joint.worldpos[t] = worldpos  # Dictionary-based approach
    # print(joint.worldpos)
...
def process_bvhfile(filename, DEBUG=True):
